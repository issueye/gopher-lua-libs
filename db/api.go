...
type dbConfig struct {
	// connString
	// sqlserver dns[Provider=SQLOLEDB;Data Source=192.168.200.66;Initial Catalog=test;User ID=sa;Password=123456;port=1433;]
	// mysql dns[root@tcp(mysql:3306)/test?charset=utf8&parseTime=True&loc=Local]
	// sqlite3 dns[sqlite3:///test.db]
	// postgres dns[postgres://postgres:postgres@localhost:5432/test]
	connString   string
	sharedMode   bool
	maxOpenConns int
	readOnly     bool
